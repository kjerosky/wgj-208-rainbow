...
draw_sprite(sWgjLogo, -1, centerX, centerY - 8);

draw_set_color(c_white);
draw_set_halign(fa_center);

draw_set_valign(fa_bottom);
draw_text(centerX, centerY - sprite_get_height(sWgjLogo) / 2 - 10 - 8, "WeeklyGameJam - Week 208");

draw_set_valign(fa_top);
draw_text(centerX, centerY + sprite_get_height(sWgjLogo) / 2 + 10 - 8, "Submission by\nKeith Jerosky");
